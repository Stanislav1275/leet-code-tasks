...
// import { exaple_ecdsa } from "./esdsa";
// let t = new TreeNode(
//   6,
//   new TreeNode(
//     2,
//     new TreeNode(0, null),
//     new TreeNode(4, new TreeNode(3, null), new TreeNode(5, null)),
//   ),
//   new TreeNode(8, new TreeNode(7, null), new TreeNode(9, null)),
// );
...
import {decryptExample, encryptExample} from "./steno";

(() => {
  encryptExample("hello everybody, my name is cocktail", "12345");
  decryptExample("12345");
